...
namespace Tekken
{
  ...
  // 84 C0 74 36
  std::string HUD_NAME_SIG_BYTES = "84 C0 ?? ?? 80 BD 8A 00 00 00 00 0F 44 DE 4C 0F BE C3 49 C1";
  // 84 C0 74 43
  std::string HUD_ICON_SIG_BYTES = "84 C0 ?? ?? 80 BD 8A 00 00 00 00 40 0F B6 CE 41 0F B6 C6";
