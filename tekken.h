...
namespace Tekken
{
  ...
  // Starts at the lea rbp,[rsp-1B0] we patch for Story RA camera loading
  std::string CAMERA_HOOK_SIG_BYTES = "48 8D AC 24 50 FE FF FF 48 81 EC B0 02 00 00 48 8B 05 C0 ?? ?? ?? 48 33 C4 48 89 85 A0 01 00 00 41 8B F9";
