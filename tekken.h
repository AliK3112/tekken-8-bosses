...
namespace Tekken
{
  ...
  std::string CAMERA_HOOK_SIG_BYTES = "48 89 5C 24 08 48 89 74 24 18 55 57 41 54 41 56 41 57 48 8D AC 24 50 FE FF FF 48 81 EC B0 02 00 00 48 8B 05 ?? ?? ?? ?? 48 33 C4 48 89 85 A0 01 00 00 41 8B F9";
