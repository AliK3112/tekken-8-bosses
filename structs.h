...
//     uint32_t transformed_char_id;                  // Use Expression "(X - 1) / 0xFFFF" to get the character ID.
//     uint32_t transformed_char_id2;                 // Use Expression "((X - 1) & 0xFFFF) + 1" to get the character ID.
...
struct Motbin
{
    ...
    uint32_t transformed_char_id;       // Use Expression "(X - 1) / 0xFFFF" to get the character ID.
    uint32_t transformed_char_id2;      // Use Expression "((X - 1) & 0xFFFF) + 1" to get the character ID.
    uint64_t reactions_ptr;             // Offset: 0x168
    uint64_t string_block_end_offset;   // Offset: 0x170
    int reactions_count;                // Offset: 0x178
    uint64_t requirements_ptr;          // Offset: 0x180
    int requirements_count;             // Offset: 0x188
    uint64_t hit_conditions_ptr;        // Offset: 0x190
    int hit_conditions_count;           // Offset: 0x198
    uint64_t projectiles_ptr;           // Offset: 0x1a0
    int projectiles_count;              // Offset: 0x1a8
    uint64_t pushbacks_ptr;             // Offset: 0x1b0
    int pushbacks_count;                // Offset: 0x1b8
    uint64_t pushback_extradata_ptr;    // Offset: 0x1c0
    int pushback_extradata_count;       // Offset: 0x1c8
    uint64_t cancels_ptr;               // Offset: 0x1d0
    int cancels_count;                  // Offset: 0x1d8
    uint64_t group_cancels_ptr;         // Offset: 0x1e0
    int group_cancels_count;            // Offset: 0x1e8
    uint64_t cancel_extradata_ptr;      // Offset: 0x1f0
    int cancel_extradata_count;         // Offset: 0x1f8
    uint64_t extra_move_properties_ptr; // Offset: 0x200
    int extra_move_properties_count;    // Offset: 0x208
    uint64_t move_start_props_ptr;      // Offset: 0x210
    int move_start_props_count;         // Offset: 0x218
    uint64_t move_end_props_ptr;        // Offset: 0x220
    int move_end_props_count;           // Offset: 0x228
    uint64_t moves_ptr;                 // Offset: 0x230
    int moves_count;                    // Offset: 0x238
    uint64_t voiceclips_ptr;            // Offset: 0x240
    int voiceclips_count;               // Offset: 0x248
    uint64_t input_sequences_ptr;       // Offset: 0x250
    int input_sequences_count;          // Offset: 0x258
    uint64_t inputs_ptr;                // Offset: 0x260
    int inputs_count;                   // Offset: 0x268
    uint64_t parryable_list_ptr;        // Offset: 0x270
    int parryable_list_count;           // Offset: 0x278
    uint64_t throw_extras_ptr;          // Offset: 0x280
    int throw_extras_count;             // Offset: 0x288
    uint64_t throws_ptr;                // Offset: 0x290
    int throws_count;                   // Offset: 0x298
    uint64_t dialogues_ptr;             // Offset: 0x2a0
    int dialogues_count;                // Offset: 0x2a8
    void *mota0;                        // Offset: 0x2b0 - Body Mota. No longer used, always 0
    void *mota1;                        // Offset: 0x2b8 - Body Mota. No longer used, always 0
    void *mota2;                        // Offset: 0x2c0 - Hand Mota. No longer used, always 0
